...
<!-- Header Block -->
<section>
<h1 class="text-6xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-orange-400 tracking-tighter leading-tight mb-2">
                        Pratham Chintamani
                    </h1>
<p class="text-2xl text-on-surface-variant font-medium">Electrical engineering student | Indian Institute of Technology, Tirupati</p>
</section>
<!-- UI Divider -->
...
<!-- MOSTLY WORKING ON -->
<section>
<h2 class="text-s font-bold uppercase tracking-[0.2em] text-red-400 mb-4 flex items-center gap-2">
                            MOSTLY WORKING ON:
                        </h2>
<ul class="space-y-3">
